...
SRCS = main.c glitch.c time.c time_utils.c init.c init2.c init3.c init4.c parsing.c map_parse.c file_parse.c mem_utils.c cleanup.c dda.c dda_door.c door.c draw.c draw2.c draw3.c draw4.c draw_utils.c draw_utils2.c anim_utils.c handler.c keys.c m_press.c m_move.c loop.c loop2.c loop3.c loop4.c fullscreen.c movements.c str_help.c helper_func.c m_press2.c m_press3.c
