...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/24 15:06:20 by rmota-ma          #+#    #+#             */
/*   Updated: 2025/11/24 15:18:11 by rmota-ma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	g_win_put(void)
{
	...
	draw_img(&game()->g_win_bg, &temp, 0, 0);
	draw_img(&game()->star[star], &temp, 701, 441);
